...
class AuthService constructor(private val firebaseAuth: FirebaseAuth) {
    ...
    //    firebaseAuth.firebaseAuthSettings.setAutoRetrievedSmsCodeForPhoneNumber("+52 5524868255", "555555")
